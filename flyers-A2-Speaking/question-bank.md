# Cambridge Flyers A2 Speaking — Official Question Bank

Source: *Go Flyers Teacher's Notes* (H.Q. Mitchell & Marileni Malkogianni, MM Publications, 2018 YLE Revised Edition)

---

## HOW TO USE

At the start of every session, run **Part 0** (warm-up + test selection), then proceed through **Parts 1–4** of the chosen test using the **exact examiner scripts** below.

**Examiner rules:**
- Use ONLY the scripted words. Do not paraphrase.
- Wait for the student's response before continuing.
- If silent, use only the listed prompt questions.
- Do NOT correct during the test. Give feedback after Part 4 ends.

---

## PART 0 — Warm-Up (Same for All Tests)
...
> *"Which test would you like to do today — Test 1, Test 2, Test 3, Test 4, or Test 5?"*

**Minimum response expected:** Hello. / (first name) / (surname) / (age) / Test (number)

**Alternative prompts if no response:**
> *"What's your family name?"* / *"Are you twelve years old?"*
...
**Scene:** Two pictures of an outdoor picnic scene near a lake (tent, bikes, blanket)
...
**5 differences (find after example):**

| Examiner says | Student should say |
|---|---|
| *"In my picture, two boys are sitting under a tree."* | *"In my picture, two girls are sitting under a tree."* |
| *"In my picture, the woman is eating a sandwich."* | *"In my picture, the woman is eating pizza."* |
| *"In my picture, there isn't a pizza on the blanket."* | *"In my picture there is a pizza on the blanket."* |
| *"In my picture, two boys are riding their bikes."* | *"In my picture, one boy is riding his bike."* |
| *"In my picture, a man is reading a newspaper outside the tent."* | *"In my picture, a man is reading a magazine outside the tent."* |

**Prompt questions (use only if student is silent):**
- *"Who is sitting under a tree in your picture?"*
- *"What is the woman eating?"*
- *"What's on the blanket?"*
- *"How many boys are riding their bikes?"*
- *"What is the man outside the tent reading?"*

---

### Part 2 — Information Exchange
**Context:** Richard and Harry are friends who go to school together.
...
**Examiner asks about Richard (student answers):**

| Examiner asks | Student's answer |
|---|---|
| *"What time does he get up in the morning?"* | At 7:00. |
| *"What time does he go to school?"* | At 8:00. |
| *"What does he do at 4:00 p.m.?"* | He does his homework. |
| *"What does he do at 7:00 p.m.?"* | He has a tennis lesson. |
| *"What time does he go to bed?"* | At 10:00. |

**Transition:**
> *"Now, you don't know anything about Harry's programme, so you ask me some questions."*
...
**Story title:** *"Betty's visit to London"*
...
### Part 1 — Find the Differences
**Scene:** Two pictures of a fire station
...
| Examiner says | Student should say |
|---|---|
| *"In my picture, the man who is going to the toilet is wearing a white shirt."* | *"In my picture, the man who is going to the toilet is wearing a black shirt."* |
| *"In my picture, the driver in the fire engine has got a beard."* | *"In my picture, the driver has got a moustache."* |
| *"In my picture, a man is going up the stairs."* | *"In my picture, the man is going down the stairs."* |
| *"In my picture, there is a restaurant next to the fire station."* | *"In my picture, there is a bookshop next to the fire station."* |
| *"In my picture, there is a motorbike near the trees."* | *"In my picture, there is a bike near the trees."* |

**Prompt questions:**
- *"Is the man wearing a white shirt?"*
- *"Has the driver got a beard?"*
- *"Is the man going up the stairs?"*
- *"Is there a restaurant next to the fire station?"*
- *"Is there a motorbike near the trees?"*

---

### Part 2 — Information Exchange
**Context:** Mr Brown and Mrs Silver are two teachers.

**Examiner's opening:**
> *"Mr Brown and Mrs Silver are two teachers. I don't know anything about Mr Brown, but you do. So I'm going to ask you some questions."*

**Examiner asks about Mr Brown (student answers):**

| Examiner asks | Student's answer |
|---|---|
| *"What's his name?"* | Richard. |
| *"How old is he?"* | He's 37. |
| *"What subject does he teach?"* | Geography. |
| *"How many years has he been a teacher?"* | Eight. |
| *"Is he married?"* | Yes. |

**Transition:**
> *"Now, you don't know anything about Mrs Silver, so you ask me some questions."*
...
### Part 3 — Tell the Story
**Story title:** *"Michael's dream"*

**Examiner describes Picture 1:**
> *"These pictures tell a story. It's called 'Michael's dream'. Look at the pictures first."*
>
> *"Michael is very tired. He brushes his teeth and he's getting ready to go to bed."*
>
> *"Now you tell the story."*
...
> *"Now, let's talk about what you do in the summer."*

1. *"Where do you like going for your holidays?"*
...
**Ending:** *"OK. Thank you, [name]. Goodbye."*
...
### Part 1 — Find the Differences
**Scene:** Two pictures of a countryside scene (farm, lake, bridge, truck)
...
| Examiner says | Student should say |
|---|---|
| *"In my picture, the girl who is cleaning the table is wearing glasses."* | *"In my picture, the girl isn't wearing glasses."* |
| *"In my picture, there are two rabbits behind the tree."* | *"In my picture, there are three rabbits behind the tree."* |
| *"In my picture, there is a swan in the lake."* | *"In my picture, there is a duck in the lake."* |
| *"In my picture, the woman on the bridge is wearing a ring."* | *"In my picture, the woman isn't wearing a ring."* |
| *"In my picture, there is a driver in the truck."* | *"In my picture, there isn't a driver in the truck."* |

**Prompt questions:**
- *"Is the girl wearing glasses?"*
- *"How many rabbits are there behind the tree?"*
- *"Is there a swan in the lake?"*
...
### Part 2 — Information Exchange
**Context:** Robert and William are brothers who each have a pet.

**Examiner's opening:**
> *"Robert and William are brothers. They have got two pets. I don't know anything about Robert's pet, but you do. So I'm going to ask you some questions."*

**Examiner asks about Robert's pet (student answers):**

| Examiner asks | Student's answer |
|---|---|
| *"What pet has he got?"* | A rabbit. |
| *"What's its name?"* | Snowball. |
| *"What colour is it?"* | It's white. |
| *"What's its favourite food?"* | Carrots. |
| *"Where does it live?"* | It lives in a cage. |

**Transition:**
> *"Now, you don't know anything about William's pet, so you ask me some questions."*
...
### Part 1 — Find the Differences
**Scene:** Two pictures of a fishing trip (boat, boys, fish)
...
| Examiner says | Student should say |
|---|---|
| *"In my picture, it's windy and it's raining."* | *"In my picture it isn't raining."* |
| *"In my picture, the first boy has got a knife in his pocket."* | *"In my picture, he has got a fork in his pocket."* |
| *"In my picture, the third boy is carrying a rucksack."* | *"In my picture, he isn't carrying a rucksack."* |
| *"In my picture, the third boy isn't holding anything."* | *"In my picture, the third boy is holding a map."* |
| *"In my picture, there are four fish in the boat."* | *"In my picture, there are five fish."* |
...
- *"How many fish are there in the boat?"*

---

### Part 2 — Information Exchange
**Context:** Helen and Katy are best friends, each with a favourite toy.

**Examiner's opening:**
> *"Helen and Katy are best friends. They have got a favourite toy each. I don't know anything about Helen's favourite toy, but you do. So I'm going to ask you some questions."*

**Examiner asks about Helen's toy (student answers):**

| Examiner asks | Student's answer |
|---|---|
| *"What is Helen's favourite toy?"* | A doll. |
| *"What colour is it?"* | It's pink. |
| *"What is it made of?"* | Plastic. |
| *"Why does she like it?"* | Her mum bought it for her. |
| *"How long has she had it?"* | A year. |

**Transition:**
> *"Now, you don't know anything about Katy's favourite toy, so you ask me some questions."*
...
2. *"How old are you going to be when you get married?"*
3. *"Where would you like to live?"*
4. *"How many children would you like to have?"*

**Sample answers:** Businessman/Businesswoman. / 25. / In a big city. / Two.
...
### Part 1 — Find the Differences
**Scene:** Two pictures of an indoor scene with a table, plant, and a woman
...
| Examiner says | Student should say |
|---|---|
| *"In my picture, the bottle of water is full."* | *"In my picture, the bottle is empty."* |
| *"In my picture, there are flowers on the table."* | *"In my picture, there are sweets on the table."* |
| *"In my picture, there is a pair of scissors under the table."* | *"In my picture, there is a belt under the table."* |
| *"In my picture, there is an insect on the plant."* | *"In my picture, there are two insects on the plant."* |
| *"In my picture, the woman is wearing a spotted dress."* | *"In my picture, the woman is wearing a striped dress."* |

**Prompt questions:**
- *"Is there any water in the bottle?"*
- *"What is on the table?"*
- *"What is there under the table?"*
- *"What's on the plant in your picture?"*
- *"What kind of dress is the woman wearing?"*

---

### Part 2 — Information Exchange
**Context:** Betty and Helen are friends who each went on a holiday.

**Examiner's opening:**
> *"Betty and Helen are friends. They took some pictures of their last holiday. I don't know anything about Betty's holiday, but you do. So I'm going to ask you some questions."*

**Examiner asks about Betty's holiday (student answers):**

| Examiner asks | Student's answer |
|---|---|
| *"Where did she go?"* | To the beach. |
| *"Where did she stay?"* | In a tent. |
| *"Who did she go with?"* | With her family. |
| *"When did she go?"* | In July. |
| *"What did she do there?"* | She went swimming. |

**Transition:**
> *"Now, you don't know anything about Helen's holiday, but I do. So you are going to ask me some questions."*
...
### Part 3 — Tell the Story
**Story title:** *"Family shopping"*

**Examiner describes Picture 1:**
> *"These pictures tell a story. It's called 'Family shopping'. Look at the pictures first."*
>
> *"Richard and his parents go to a shop. There are bookcases there."*
>
> *"Now you tell the story."*
